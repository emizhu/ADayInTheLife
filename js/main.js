...
$(".bg").css("height", $(window).height());
 ...
 new fullpage('#fullpage', {
     ...
     navigation: true,
     menu: '#myMenu',
     anchors: ['page_01', 'page_02', 'page_03', 'page_04', 'page_05','page_06', 'page_07', 'page_08', 'page_09', 'page_10', 'page_11'],
     navigationPosition: 'right',
     navigationTooltips: ['01', '02', '03', '04', '05','06', '07', '08', '09', '10', '11'],
     showActiveTooltip: true,
     slidesNavigation: true,
     sectionsColor: ['white', '#404040', 'white', '#404040','white','#404040','white','#404040','#404040', '#404040', '#404040'],
